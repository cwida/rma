 ...
 * impl2.hpp
 *
 * From: https://github.com/reddragon/packed-memory-array/blob/master/impl2.cpp
 */

#ifndef IMPL_REDDRAGON_IMPL2_HPP_
#define IMPL_REDDRAGON_IMPL2_HPP_
...
struct PMA {
    ...
    struct PMAIterator {
        ...
        bool
        operator==(const PMAIterator& rhs) const {
...
//                int sz; // warning: unused var
    ...
    insert_merge(int l, E v) {
        ...
        auto iter = std::lower_bound(tmp.begin(), tmp.end(), v);
        tmp.insert(iter, v);
...
#endif /* IMPL_REDDRAGON_IMPL2_HPP_ */
