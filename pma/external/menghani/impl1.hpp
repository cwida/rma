 ...
 * impl1.cpp
 *
 * From: https://github.com/reddragon/packed-memory-array -> impl1.cpp
 */
...
namespace reddragon { namespace impl1 {
...
class PackedMemoryArray {
    ...
    public:
//    PackedMemoryArray(); // not implemented
    PackedMemoryArray(E e);
//    PackedMemoryArray(std::vector<E> v); // not implemented
    ~PackedMemoryArray();
...
inline void PackedMemoryArray<E>::insert_element(E e) {
    ...
    std::cout << "# Insert element " << e << " at pos " << pos << std::endl;
